<header>
    <div class="bg-white">
        <!-- banner - start -->
        <div class="relative flex flex-wrap bg-blue-500 px-4 py-3 sm:flex-nowrap sm:items-center sm:justify-center sm:gap-3 sm:pr-8 md:px-8">
          ...
          <a href="#" class="order-last inline-block w-full whitespace-nowrap rounded-lg bg-amber-500 px-4 py-2 text-center text-xs font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-700 focus-visible:ring active:bg-indigo-800 sm:order-none sm:w-auto md:text-sm">Learn more</a>
