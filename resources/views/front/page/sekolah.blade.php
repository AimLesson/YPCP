...
@section('content')
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        ...
        <div class="grid gap-8 md:grid-cols-1 lg:gap-12">    
            <div class="md:pt-8">  
                <h1 class="mb-4 text-center text-2xl font-bold text-indigo-500 sm:text-3xl md:mb-6 md:text-left">Tentang Kami</h1>
        
                @if (!empty($sekolah) && !empty($sekolah->about))
                    <p class="mb-6 text-justify text-gray-500 sm:text-lg md:mb-8">
